...
type LayoutRouteId = RouteId | "/" | "/admin" | "/admin/email" | "/admin/homepage" | "/admin/homepage/challenges/[specificChallenge]" | "/admin/homepage/faq/[faqQuestion]" | "/admin/homepage/schedule/[event]" | "/admin/questions" | "/admissions" | "/apply" | "/id" | "/login" | "/login/reset-password" | "/login/verify-email/[token]" | "/logout" | "/register" | "/scan" | "/scan/[action]" | "/unverified" | "/users" | null
type LayoutParams = RouteParams & { specificChallenge?: string; faqQuestion?: string; event?: string; token?: string; action?: string }
