...
const load = async ({ locals, url }) => {
  ...
  return {
    ...
    questions: user.roles.includes("ADMIN") ? questions : questions.filter((question) => question.sponsorView),
    users: results.users,
    pages: results.pages,
    start: results.start,
    count: results.count,
